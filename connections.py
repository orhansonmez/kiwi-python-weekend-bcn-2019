...
def get_connections(source, destination, departure_date):
    ...
    connections = redis.get('bcn_orhan:journey:{}_{}_{}'.format(slugify(source), slugify(destination), departure_date))
    ...
    search_url = "https://shop.global.flixbus.com/search?departureCity={}&arrivalCity={}&route={}-{}&rideDate={}"\
        .format(source_id, destination_id, source, destination, departure_datetime.strftime("%d.%m.%Y"))
    ...
    redis.set('bcn_orhan:journey:{}_{}_{}'.format(slugify(source), slugify(destination), departure_date), json.dumps(connections))
...
if __name__ == '__main__':
    ...
    connections = get_connections(args.source, args.destination, args.departure_date)
    print(connections)